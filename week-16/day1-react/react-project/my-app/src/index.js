...
import Hotels from './Hotels';
  ...
  //const element2 = <SecondComponent items={listOfItems} />;
  //const element1 = <FirstComponent />;
 

ReactDOM.render(
    <React.StrictMode >
        <FirstComponent />
         <SecondComponent  items={data.filters['Star rating']} />
         <ThirdComponent  items={data.filters['Property type']} />
         <Hotels items={data.hotels}/>
